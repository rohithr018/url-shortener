...
const Card = ({ title, children }) => (
  <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-2xl shadow-md p-6 w-full min-h-[500px] transition-all hover:shadow-lg flex flex-col justify-start">
    <h2 className="text-xl font-semibold text-black dark:text-white mb-4 text-center">{title}</h2>
    <div className="w-full flex-1 flex items-center justify-center">{children}</div>
  </div>
);

const NoData = () => (
  <div className="text-gray-500 dark:text-zinc-400 text-sm italic text-center">No data available</div>
);
...
export default function AnalyticsPage() {
  ...
  if (!analytics) {
    return (
      <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-zinc-950 text-gray-500 dark:text-zinc-400 text-lg">
        Loading analytics...
      </div>
    );
  }
  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll scroll-smooth no-scrollbar bg-white dark:bg-gray-950 text-black dark:text-white px-4 md:px-8 py-12 ">
      {/* Title */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <Card title="Hourly Click Activity">
          {analytics.hourlyClicks.some((c) => c > 0) ? (
            <Bar
              data={{
                ...
                datasets: [
                  {
                    ...
                    backgroundColor: ['#e11d48', '#8b5cf6', '#3b82f6', '#10b981', '#f97316'],
                  },
                ],
              }}
              options={chartOptions}
